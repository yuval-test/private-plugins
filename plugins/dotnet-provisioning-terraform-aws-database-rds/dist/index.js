...
exports.pgSgIdentifierKey = exports.pgBackupRetentionPeriodKey = exports.pgBackupWindowKey = exports.pgMaintenanceWindowKey = exports.pgDatabasePortKey = exports.pgDatabaseUsernameKey = exports.pgDatabaseNameKey = exports.pgDatabaseInstanceClassKey = exports.pgMaximumStorageKey = exports.pgAllocatedStorageKey = exports.pgDatabaseIdentifierKey = exports.moduleNameSgKey = exports.moduleNameRdsKey = void 0;
// generic constants
exports.moduleNameRdsKey = "${{ RDS_MODULE_NAME }}";
exports.moduleNameSgKey = "${{ SG_MODULE_NAME }}";
// settings database - postgresql (pg) constants
exports.pgDatabaseIdentifierKey = "${{ DATABASE_IDENTIFIER }}";
exports.pgAllocatedStorageKey = "${{ ALLOCATED_STORAGE }}";
exports.pgMaximumStorageKey = "${{ MAXIMUM_STORAGE }}";
exports.pgDatabaseInstanceClassKey = "${{ INSTANCE_CLASS }}";
exports.pgDatabaseNameKey = "${{ DATABASE_NAME }}";
exports.pgDatabaseUsernameKey = "${{ DATABASE_USERNAME }}";
exports.pgDatabasePortKey = "${{ DATABASE_PORT }}";
exports.pgMaintenanceWindowKey = "${{ MAINTENANCE_WINDOWS }}";
exports.pgBackupWindowKey = "${{ BACKUP_WINDOW }}";
exports.pgBackupRetentionPeriodKey = "${{ BACKUP_RETENTION_PERIOD }}";
exports.pgSgIdentifierKey = "${{ SECURITY_GROUP_IDENTIFIER }}";
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isPostgresSettings = void 0;
function isPostgresSettings(settings) {
    return settings.postgres !== undefined;
}
exports.isPostgresSettings = isPostgresSettings;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getTerraformDirectory = exports.getPluginSettings = void 0;
...
const getTerraformDirectory = (pluginInstallations, serverBaseDirectory) => {
    const plugin = pluginInstallations.find((plugin) => plugin.npm === "@amplication/plugin-dotnet-provisioning-terraform-aws-core");
    if (!plugin) {
        throw new Error("TerraformAwsDatabaseRdsPlugin: is dependent on 'Terraform - AWS Core' plugin");
    }
...
exports.getTerraformDirectory = getTerraformDirectory;
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"settings":{"postgres":{"identifier":"","instance_class":"db.t4g.medium","database_name":"","username":"postgres","port":5432,"storage":{"allocated":20,"maximum":100},"maintenance":{"window":"Mon:00:00-Mon:03:00"},"backup":{"window":"03:00-06:00","retention_period":14},"security_group":{"name":""}}},"systemSettings":{"requireAuthenticationEntity":"false"}}');
...
class TerraformAwsDatabaseRdsPlugin {
    register() {
        return {
            LoadStaticFiles: {
    ...
    async afterLoadStaticFiles(context, eventParams, files) {
        ...
        // repository name
        const serviceName = (0, lodash_1.kebabCase)(context.resourceInfo?.name);
        if (!serviceName) {
            throw new Error("TerraformAwsRepositoryEcrPlugin: Service name is undefined");
        }
        ...
        const terraformDirectory = (0, utils_1.getTerraformDirectory)(context.pluginInstallations, context.serverDirectories.baseDirectory);
        ...
        const underscoreName = (0, lodash_1.snakeCase)(serviceName);
        const hyphenName = (0, lodash_1.kebabCase)(serviceName);
        ...
        if ((0, types_1.isPostgresSettings)(settings)) {
            staticPath = (0, path_1.resolve)(__dirname, "./static/postgres");
        ...
        const staticFiles = await context.utils.importStaticFiles(staticPath, terraformDirectory);
        if ((0, types_1.isPostgresSettings)(settings)) {
            for (const item of staticFiles.getAll()) {
                const newCode = item.code
                    .replaceAll(constants_1.moduleNameRdsKey, "rds_" + underscoreName)
                    .replaceAll(constants_1.moduleNameSgKey, "sg_" + underscoreName)
                    .replaceAll(constants_1.pgDatabaseIdentifierKey, databaseIdentifier)
                    .replaceAll(constants_1.pgAllocatedStorageKey, String(settings.postgres.storage.allocated))
                    .replaceAll(constants_1.pgMaximumStorageKey, String(settings.postgres.storage.maximum))
                    .replaceAll(constants_1.pgDatabaseNameKey, (0, lodash_1.camelCase)(databaseName))
                    .replaceAll(constants_1.pgDatabaseUsernameKey, settings.postgres.username)
                    .replaceAll(constants_1.pgDatabasePortKey, String(settings.postgres.port))
                    .replaceAll(constants_1.pgDatabaseInstanceClassKey, settings.postgres.instance_class)
                    .replaceAll(constants_1.pgMaintenanceWindowKey, settings.postgres.maintenance.window)
                    .replaceAll(constants_1.pgBackupWindowKey, settings.postgres.backup.window)
                    .replaceAll(constants_1.pgBackupRetentionPeriodKey, String(settings.postgres.backup.retention_period))
                    .replaceAll(constants_1.pgSgIdentifierKey, "rds-" + securityGroupName);
                const newPath = item.path.replace(templateFileName, fileNamePrefix + hyphenName + fileNameSuffix);
                const file = {
                    path: newPath,
...
exports["default"] = TerraformAwsDatabaseRdsPlugin;
